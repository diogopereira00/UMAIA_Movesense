...
//        initSwitchListener();
    ...
    private fun gerarLista() {
        ...
        settingsList.add(SettingsClass(id = "Sensores", name = "Os seus sensores", description = "Ative ou desative a recolha de determinados dados, ou altere a frequência da sua recolha.", icon = R.drawable.ic_baseline_sensors_24))
...
//        settingsList.add(SettingsClass(id = "Recursos adicionais",name = "Recursos adicionais", description = "Verifique informações uteis do RackIT", icon = R.drawable.ic_baseline_more_horiz_24))
        settingsList.add(SettingsClass(id = "Logout",name = "Terminar sessão", description = "Termine sessão em segurança", icon = R.drawable.ic_baseline_logout_24))
