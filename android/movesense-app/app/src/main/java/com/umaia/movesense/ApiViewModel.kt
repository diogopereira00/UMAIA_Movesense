...
class ApiViewModel(
    ...
    private val _getAllStudiesFromUserIDReponse: MutableLiveData<Resource<StudiesResponse>> =
        MutableLiveData()
    ...
    fun getAllStudiesFromId(
        ...
        _getAllStudiesFromUserIDReponse.value =
            repository.getAllStudiesFromUser(userID, authToken = "Bearer $authToken")
    }

    //getStudyVersion
    private val _getStudyVersionResponse: MutableLiveData<Resource<StudyVersionResponse>> =
        MutableLiveData()
    val getStudyVersionResponse: LiveData<Resource<StudyVersionResponse>>
        get() = _getStudyVersionResponse

    fun getStudyVersion(
        studyID: String,
        authToken: String
    ) = viewModelScope.launch {
        _getStudyVersionResponse.value =
            repository.getStudyVersion(studyID = studyID, authToken = "Bearer $authToken")
    }
    ...
    //getQuestionTypes
    private val _getQuestionTypes: MutableLiveData<Resource<QuestionTypesResponse>> =
        MutableLiveData()
    ...
    fun getQuestionOptions(
        ...
        _getQuestionOptions.value =
            repository.getAllQuestionsOptions(authToken = "Bearer $authToken")
    }
